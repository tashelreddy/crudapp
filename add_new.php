...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `crud`(`id`, `full_name`, `address`, `contact`, `email`, `gender`, `course`, `last_session`, `status`) 
      VALUES (NULL,'$full_name','$address','$contact','$email','$gender','$course','$last_session','$status')";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <div class="container d-flex justify-content-center">
                    ...
                    <input type="radio" class="form-check-input active mx-1" name="gender" id="male" value="male">
                    &nbsp;
                    ...
                    <input type="radio" class="form-check-input" name="gender" id="female" value="female">
                     ...
                     <label class="form-label">Last Session</label>
                      <input type="text" class="form-control" name="last_session" placeholder="">
                     </div>

                     <div class="form-group mb-3">
                    <label>Status:</label> &nbsp;
                    <label for="active" class="form-input-label">Active</label>
                    <input type="radio" class="form-check-input active mx-1" name="status" id="active" value="active">
                    &nbsp;
                    ...
                    <input type="radio" class="form-check-input" name="status" id="inactive" value="inactive">
                     ...
                     <div>
                        <button type="submit" class="btn btn-success bg-success text-white" name="submit">Save</button>
